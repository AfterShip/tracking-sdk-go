...
Each SDK version is designed to work with a specific API version. Please refer to the table below to identify the
supported API versions for each SDK version, ensuring you select the appropriate SDK version for the API version you
intend to use.
...
```bash
go get -u github.com/aftership/tracking-sdk-go/v7
```
...
import (
	"fmt"
	"github.com/aftership/tracking-sdk-go/v7"
)
...
See the [Rate Limit](https://www.aftership.com/docs/tracking/2025-01/quickstart/api-quick-start) to understand the
AfterShip rate limit policy.
...
- [Issue Tracker](https://github.com/AfterShip/tracking-sdk-go/issues) for questions, feature requests, bug reports and
