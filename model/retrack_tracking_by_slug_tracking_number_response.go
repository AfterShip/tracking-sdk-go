...
// RetrackTrackingBySlugTrackingNumberResponse Object describes the tracking information.<div style="display:none; height: 0"></div>
type RetrackTrackingBySlugTrackingNumberResponse struct {
	...
	ShipmentWeight *ShipmentWeightRetrackTrackingBySlugTrackingNumberResponse `json:"shipment_weight,omitempty"`
	...
	AftershipEstimatedDeliveryDate *AftershipEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse `json:"aftership_estimated_delivery_date,omitempty"`
	...
	CustomEstimatedDeliveryDate *CustomEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse `json:"custom_estimated_delivery_date,omitempty"`
	...
	FirstEstimatedDelivery *FirstEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse `json:"first_estimated_delivery,omitempty"`
	...
	LatestEstimatedDelivery *LatestEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse `json:"latest_estimated_delivery,omitempty"`
	...
	NextCouriers []NextCouriersRetrackTrackingBySlugTrackingNumberResponse `json:"next_couriers,omitempty"`
	...
	CarbonEmissions *CarbonEmissionsRetrackTrackingBySlugTrackingNumberResponse `json:"carbon_emissions,omitempty"`
...
type ShipmentWeightRetrackTrackingBySlugTrackingNumberResponse struct {
...
type AftershipEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse struct {
...
type CustomEstimatedDeliveryDateRetrackTrackingBySlugTrackingNumberResponse struct {
...
type FirstEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse struct {
	// Type The format of the EDD. Either a single date or a date range.
	Type string `json:"type,omitempty"`
...
type LatestEstimatedDeliveryRetrackTrackingBySlugTrackingNumberResponse struct {
	// Type The format of the EDD. Either a single date or a date range.
	Type string `json:"type,omitempty"`
	// Source The source of the EDD. Either the carrier, AfterShip AI, or based on your custom EDD settings.
	Source string `json:"source,omitempty"`
...
type NextCouriersRetrackTrackingBySlugTrackingNumberResponse struct {
...
type CarbonEmissionsRetrackTrackingBySlugTrackingNumberResponse struct {
