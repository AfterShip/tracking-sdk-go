...
type EstimatedDeliveryDateResponse struct {
    ...
    OriginAddress *OriginAddressEstimatedDeliveryDateResponse `json:"origin_address"`
    // DestinationAddress The final destination of the customer where the delivery will be made.
    DestinationAddress *DestinationAddressEstimatedDeliveryDateResponse `json:"destination_address"`
    // Weight AfterShip uses this object to calculate the total weight of the order.
    Weight *WeightEstimatedDeliveryDateResponse `json:"weight,omitempty"`
    ...
    EstimatedPickup *EstimatedPickupEstimatedDeliveryDateResponse `json:"estimated_pickup,omitempty"`
...
type OriginAddressEstimatedDeliveryDateResponse struct {
...
type DestinationAddressEstimatedDeliveryDateResponse struct {
...
type WeightEstimatedDeliveryDateResponse struct {
...
type EstimatedPickupEstimatedDeliveryDateResponse struct {
    ...
    // OrderProcessingTime 
    OrderProcessingTime *OrderProcessingTimeEstimatedPickupEstimatedDeliveryDateResponse `json:"order_processing_time,omitempty"`
    // PickupTime The local pickup time of the package. 
    PickupTime string `json:"pickup_time,omitempty"`
}

// OrderProcessingTimeEstimatedPickupEstimatedDeliveryDateResponse 
type OrderProcessingTimeEstimatedPickupEstimatedDeliveryDateResponse struct {
