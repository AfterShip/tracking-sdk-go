...
// GetTrackingBySlugTrackingNumberResponse Object describes the tracking information.<div style="display:none; height: 0"></div>
type GetTrackingBySlugTrackingNumberResponse struct {
	// Id Tracking ID.
	...
	ShipmentWeight *ShipmentWeightGetTrackingBySlugTrackingNumberResponse `json:"shipment_weight,omitempty"`
	...
	AftershipEstimatedDeliveryDate *AftershipEstimatedDeliveryDateGetTrackingBySlugTrackingNumberResponse `json:"aftership_estimated_delivery_date,omitempty"`
	...
	CustomEstimatedDeliveryDate *CustomEstimatedDeliveryDateGetTrackingBySlugTrackingNumberResponse `json:"custom_estimated_delivery_date,omitempty"`
	...
	FirstEstimatedDelivery *FirstEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse `json:"first_estimated_delivery,omitempty"`
	...
	LatestEstimatedDelivery *LatestEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse `json:"latest_estimated_delivery,omitempty"`
	...
	NextCouriers []NextCouriersGetTrackingBySlugTrackingNumberResponse `json:"next_couriers,omitempty"`
	...
	CarbonEmissions *CarbonEmissionsGetTrackingBySlugTrackingNumberResponse `json:"carbon_emissions,omitempty"`
...
type ShipmentWeightGetTrackingBySlugTrackingNumberResponse struct {
...
type AftershipEstimatedDeliveryDateGetTrackingBySlugTrackingNumberResponse struct {
...
type CustomEstimatedDeliveryDateGetTrackingBySlugTrackingNumberResponse struct {
...
type FirstEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse struct {
	// Type The format of the EDD. Either a single date or a date range.
	Type string `json:"type,omitempty"`
...
type LatestEstimatedDeliveryGetTrackingBySlugTrackingNumberResponse struct {
	// Type The format of the EDD. Either a single date or a date range.
	Type string `json:"type,omitempty"`
	// Source The source of the EDD. Either the carrier, AfterShip AI, or based on your custom EDD settings.
	Source string `json:"source,omitempty"`
...
type NextCouriersGetTrackingBySlugTrackingNumberResponse struct {
...
type CarbonEmissionsGetTrackingBySlugTrackingNumberResponse struct {
