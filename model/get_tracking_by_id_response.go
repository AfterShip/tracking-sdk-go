...
// GetTrackingByIdResponse Object describes the tracking information.<div style="display:none; height: 0"></div>
type GetTrackingByIdResponse struct {
    ...
    CourierEstimatedDeliveryDate *CourierEstimatedDeliveryDateGetTrackingByIdResponse `json:"courier_estimated_delivery_date,omitempty"`
    ...
    ShipmentWeight *ShipmentWeightGetTrackingByIdResponse `json:"shipment_weight,omitempty"`
    ...
    AftershipEstimatedDeliveryDate *AftershipEstimatedDeliveryDateGetTrackingByIdResponse `json:"aftership_estimated_delivery_date,omitempty"`
    ...
    CustomEstimatedDeliveryDate *CustomEstimatedDeliveryDateGetTrackingByIdResponse `json:"custom_estimated_delivery_date,omitempty"`
    ...
    FirstEstimatedDelivery *FirstEstimatedDeliveryGetTrackingByIdResponse `json:"first_estimated_delivery,omitempty"`
    ...
    LatestEstimatedDelivery *LatestEstimatedDeliveryGetTrackingByIdResponse `json:"latest_estimated_delivery,omitempty"`
    ...
    CarbonEmissions *CarbonEmissionsGetTrackingByIdResponse `json:"carbon_emissions,omitempty"`
    ...
    FirstMile *FirstMileGetTrackingByIdResponse `json:"first_mile,omitempty"`
    ...
    LastMile *LastMileGetTrackingByIdResponse `json:"last_mile,omitempty"`
    ...
    Customers []CustomersGetTrackingByIdResponse `json:"customers,omitempty"`
}

// CourierEstimatedDeliveryDateGetTrackingByIdResponse 
type CourierEstimatedDeliveryDateGetTrackingByIdResponse struct {
...
type ShipmentWeightGetTrackingByIdResponse struct {
...
type AftershipEstimatedDeliveryDateGetTrackingByIdResponse struct {
...
type CustomEstimatedDeliveryDateGetTrackingByIdResponse struct {
...
type FirstEstimatedDeliveryGetTrackingByIdResponse struct {
    // Type The format of the EDD. Either a single date or a date range.
    Type string `json:"type,omitempty"`
...
type LatestEstimatedDeliveryGetTrackingByIdResponse struct {
    // Type The format of the EDD. Either a single date or a date range.
    Type string `json:"type,omitempty"`
    // Source The source of the EDD. Either the carrier, AfterShip AI, or based on your custom EDD settings.
    Source string `json:"source,omitempty"`
...
type CarbonEmissionsGetTrackingByIdResponse struct {
...
type FirstMileGetTrackingByIdResponse struct {
...
type LastMileGetTrackingByIdResponse struct {
...
type CustomersGetTrackingByIdResponse struct {
