...
// DeleteTrackingBySlugTrackingNumberResponse Object describes the tracking information.<div style="display:none; height: 0"></div>
type DeleteTrackingBySlugTrackingNumberResponse struct {
	...
	ShipmentWeight *ShipmentWeightDeleteTrackingBySlugTrackingNumberResponse `json:"shipment_weight,omitempty"`
	...
	AftershipEstimatedDeliveryDate *AftershipEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse `json:"aftership_estimated_delivery_date,omitempty"`
	...
	CustomEstimatedDeliveryDate *CustomEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse `json:"custom_estimated_delivery_date,omitempty"`
	...
	FirstEstimatedDelivery *FirstEstimatedDeliveryDeleteTrackingBySlugTrackingNumberResponse `json:"first_estimated_delivery,omitempty"`
	...
	LatestEstimatedDelivery *LatestEstimatedDeliveryDeleteTrackingBySlugTrackingNumberResponse `json:"latest_estimated_delivery,omitempty"`
	...
	NextCouriers []NextCouriersDeleteTrackingBySlugTrackingNumberResponse `json:"next_couriers,omitempty"`
	...
	CarbonEmissions *CarbonEmissionsDeleteTrackingBySlugTrackingNumberResponse `json:"carbon_emissions,omitempty"`
...
type ShipmentWeightDeleteTrackingBySlugTrackingNumberResponse struct {
...
type AftershipEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse struct {
...
type CustomEstimatedDeliveryDateDeleteTrackingBySlugTrackingNumberResponse struct {
...
type FirstEstimatedDeliveryDeleteTrackingBySlugTrackingNumberResponse struct {
	// Type The format of the EDD. Either a single date or a date range.
	Type string `json:"type,omitempty"`
...
type LatestEstimatedDeliveryDeleteTrackingBySlugTrackingNumberResponse struct {
	// Type The format of the EDD. Either a single date or a date range.
	Type string `json:"type,omitempty"`
	// Source The source of the EDD. Either the carrier, AfterShip AI, or based on your custom EDD settings.
	Source string `json:"source,omitempty"`
...
type NextCouriersDeleteTrackingBySlugTrackingNumberResponse struct {
...
type CarbonEmissionsDeleteTrackingBySlugTrackingNumberResponse struct {
