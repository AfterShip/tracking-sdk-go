...
// RetrackTrackingByIdResponse Object describes the tracking information.<div style="display:none; height: 0"></div>
type RetrackTrackingByIdResponse struct {
    ...
    CourierEstimatedDeliveryDate *CourierEstimatedDeliveryDateRetrackTrackingByIdResponse `json:"courier_estimated_delivery_date,omitempty"`
    ...
    ShipmentWeight *ShipmentWeightRetrackTrackingByIdResponse `json:"shipment_weight,omitempty"`
    ...
    AftershipEstimatedDeliveryDate *AftershipEstimatedDeliveryDateRetrackTrackingByIdResponse `json:"aftership_estimated_delivery_date,omitempty"`
    ...
    CustomEstimatedDeliveryDate *CustomEstimatedDeliveryDateRetrackTrackingByIdResponse `json:"custom_estimated_delivery_date,omitempty"`
    ...
    FirstEstimatedDelivery *FirstEstimatedDeliveryRetrackTrackingByIdResponse `json:"first_estimated_delivery,omitempty"`
    ...
    LatestEstimatedDelivery *LatestEstimatedDeliveryRetrackTrackingByIdResponse `json:"latest_estimated_delivery,omitempty"`
    ...
    CarbonEmissions *CarbonEmissionsRetrackTrackingByIdResponse `json:"carbon_emissions,omitempty"`
    ...
    FirstMile *FirstMileRetrackTrackingByIdResponse `json:"first_mile,omitempty"`
    ...
    LastMile *LastMileRetrackTrackingByIdResponse `json:"last_mile,omitempty"`
    ...
    Customers []CustomersRetrackTrackingByIdResponse `json:"customers,omitempty"`
}

// CourierEstimatedDeliveryDateRetrackTrackingByIdResponse 
type CourierEstimatedDeliveryDateRetrackTrackingByIdResponse struct {
...
type ShipmentWeightRetrackTrackingByIdResponse struct {
...
type AftershipEstimatedDeliveryDateRetrackTrackingByIdResponse struct {
...
type CustomEstimatedDeliveryDateRetrackTrackingByIdResponse struct {
...
type FirstEstimatedDeliveryRetrackTrackingByIdResponse struct {
    // Type The format of the EDD. Either a single date or a date range.
    Type string `json:"type,omitempty"`
...
type LatestEstimatedDeliveryRetrackTrackingByIdResponse struct {
    // Type The format of the EDD. Either a single date or a date range.
    Type string `json:"type,omitempty"`
    // Source The source of the EDD. Either the carrier, AfterShip AI, or based on your custom EDD settings.
    Source string `json:"source,omitempty"`
...
type CarbonEmissionsRetrackTrackingByIdResponse struct {
...
type FirstMileRetrackTrackingByIdResponse struct {
...
type LastMileRetrackTrackingByIdResponse struct {
...
type CustomersRetrackTrackingByIdResponse struct {
