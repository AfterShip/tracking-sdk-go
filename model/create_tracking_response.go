...
// CreateTrackingResponse Object describes the tracking information.<div style="display:none; height: 0"></div>
type CreateTrackingResponse struct {
    ...
    CourierEstimatedDeliveryDate *CourierEstimatedDeliveryDateCreateTrackingResponse `json:"courier_estimated_delivery_date,omitempty"`
    ...
    ShipmentWeight *ShipmentWeightCreateTrackingResponse `json:"shipment_weight,omitempty"`
    ...
    AftershipEstimatedDeliveryDate *AftershipEstimatedDeliveryDateCreateTrackingResponse `json:"aftership_estimated_delivery_date,omitempty"`
    ...
    CustomEstimatedDeliveryDate *CustomEstimatedDeliveryDateCreateTrackingResponse `json:"custom_estimated_delivery_date,omitempty"`
    ...
    FirstEstimatedDelivery *FirstEstimatedDeliveryCreateTrackingResponse `json:"first_estimated_delivery,omitempty"`
    ...
    LatestEstimatedDelivery *LatestEstimatedDeliveryCreateTrackingResponse `json:"latest_estimated_delivery,omitempty"`
    ...
    CarbonEmissions *CarbonEmissionsCreateTrackingResponse `json:"carbon_emissions,omitempty"`
    ...
    FirstMile *FirstMileCreateTrackingResponse `json:"first_mile,omitempty"`
    ...
    LastMile *LastMileCreateTrackingResponse `json:"last_mile,omitempty"`
    ...
    Customers []CustomersCreateTrackingResponse `json:"customers,omitempty"`
}

// CourierEstimatedDeliveryDateCreateTrackingResponse 
type CourierEstimatedDeliveryDateCreateTrackingResponse struct {
...
type ShipmentWeightCreateTrackingResponse struct {
...
type AftershipEstimatedDeliveryDateCreateTrackingResponse struct {
...
type CustomEstimatedDeliveryDateCreateTrackingResponse struct {
...
type FirstEstimatedDeliveryCreateTrackingResponse struct {
    // Type The format of the EDD. Either a single date or a date range.
    Type string `json:"type,omitempty"`
...
type LatestEstimatedDeliveryCreateTrackingResponse struct {
    // Type The format of the EDD. Either a single date or a date range.
    Type string `json:"type,omitempty"`
    // Source The source of the EDD. Either the carrier, AfterShip AI, or based on your custom EDD settings.
    Source string `json:"source,omitempty"`
...
type CarbonEmissionsCreateTrackingResponse struct {
...
type FirstMileCreateTrackingResponse struct {
...
type LastMileCreateTrackingResponse struct {
...
type CustomersCreateTrackingResponse struct {
