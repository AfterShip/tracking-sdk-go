...
type UpdateTrackingBySlugTrackingNumberRequest struct {
	...
	CustomFields *CustomFieldsUpdateTrackingBySlugTrackingNumberRequest `json:"custom_fields,omitempty"`
...
type CustomFieldsUpdateTrackingBySlugTrackingNumberRequest struct {
}
