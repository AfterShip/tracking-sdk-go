...
// UpdateTrackingByIdResponse Object describes the tracking information.<div style="display:none; height: 0"></div>
type UpdateTrackingByIdResponse struct {
    // Id Tracking ID.
    ...
    CourierEstimatedDeliveryDate *CourierEstimatedDeliveryDateUpdateTrackingByIdResponse `json:"courier_estimated_delivery_date,omitempty"`
    ...
    ShipmentWeight *ShipmentWeightUpdateTrackingByIdResponse `json:"shipment_weight,omitempty"`
    ...
    AftershipEstimatedDeliveryDate *AftershipEstimatedDeliveryDateUpdateTrackingByIdResponse `json:"aftership_estimated_delivery_date,omitempty"`
    ...
    CustomEstimatedDeliveryDate *CustomEstimatedDeliveryDateUpdateTrackingByIdResponse `json:"custom_estimated_delivery_date,omitempty"`
    ...
    FirstEstimatedDelivery *FirstEstimatedDeliveryUpdateTrackingByIdResponse `json:"first_estimated_delivery,omitempty"`
    ...
    LatestEstimatedDelivery *LatestEstimatedDeliveryUpdateTrackingByIdResponse `json:"latest_estimated_delivery,omitempty"`
    ...
    CarbonEmissions *CarbonEmissionsUpdateTrackingByIdResponse `json:"carbon_emissions,omitempty"`
    ...
    FirstMile *FirstMileUpdateTrackingByIdResponse `json:"first_mile,omitempty"`
    ...
    LastMile *LastMileUpdateTrackingByIdResponse `json:"last_mile,omitempty"`
    ...
    Customers []CustomersUpdateTrackingByIdResponse `json:"customers,omitempty"`
}

// CourierEstimatedDeliveryDateUpdateTrackingByIdResponse 
type CourierEstimatedDeliveryDateUpdateTrackingByIdResponse struct {
...
type ShipmentWeightUpdateTrackingByIdResponse struct {
...
type AftershipEstimatedDeliveryDateUpdateTrackingByIdResponse struct {
...
type CustomEstimatedDeliveryDateUpdateTrackingByIdResponse struct {
...
type FirstEstimatedDeliveryUpdateTrackingByIdResponse struct {
    // Type The format of the EDD. Either a single date or a date range.
    Type string `json:"type,omitempty"`
...
type LatestEstimatedDeliveryUpdateTrackingByIdResponse struct {
    // Type The format of the EDD. Either a single date or a date range.
    Type string `json:"type,omitempty"`
    // Source The source of the EDD. Either the carrier, AfterShip AI, or based on your custom EDD settings.
    Source string `json:"source,omitempty"`
...
type CarbonEmissionsUpdateTrackingByIdResponse struct {
...
type FirstMileUpdateTrackingByIdResponse struct {
...
type LastMileUpdateTrackingByIdResponse struct {
...
type CustomersUpdateTrackingByIdResponse struct {
