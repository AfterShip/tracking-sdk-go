...
func (trackingCarbonEmissions *TrackingCarbonEmissions) SetUnit(val string) {
	trackingCarbonEmissions.Unit = &val
}

func (trackingCarbonEmissions *TrackingCarbonEmissions) SetValue(val float64) {
	trackingCarbonEmissions.Value = &val
}
