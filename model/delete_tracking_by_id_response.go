...
// DeleteTrackingByIdResponse Object describes the tracking information.<div style="display:none; height: 0"></div>
type DeleteTrackingByIdResponse struct {
    ...
    CourierEstimatedDeliveryDate *CourierEstimatedDeliveryDateDeleteTrackingByIdResponse `json:"courier_estimated_delivery_date,omitempty"`
    ...
    ShipmentWeight *ShipmentWeightDeleteTrackingByIdResponse `json:"shipment_weight,omitempty"`
    ...
    AftershipEstimatedDeliveryDate *AftershipEstimatedDeliveryDateDeleteTrackingByIdResponse `json:"aftership_estimated_delivery_date,omitempty"`
    ...
    CustomEstimatedDeliveryDate *CustomEstimatedDeliveryDateDeleteTrackingByIdResponse `json:"custom_estimated_delivery_date,omitempty"`
    ...
    FirstEstimatedDelivery *FirstEstimatedDeliveryDeleteTrackingByIdResponse `json:"first_estimated_delivery,omitempty"`
    ...
    LatestEstimatedDelivery *LatestEstimatedDeliveryDeleteTrackingByIdResponse `json:"latest_estimated_delivery,omitempty"`
    ...
    CarbonEmissions *CarbonEmissionsDeleteTrackingByIdResponse `json:"carbon_emissions,omitempty"`
    ...
    FirstMile *FirstMileDeleteTrackingByIdResponse `json:"first_mile,omitempty"`
    ...
    LastMile *LastMileDeleteTrackingByIdResponse `json:"last_mile,omitempty"`
    ...
    Customers []CustomersDeleteTrackingByIdResponse `json:"customers,omitempty"`
}

// CourierEstimatedDeliveryDateDeleteTrackingByIdResponse 
type CourierEstimatedDeliveryDateDeleteTrackingByIdResponse struct {
...
type ShipmentWeightDeleteTrackingByIdResponse struct {
...
type AftershipEstimatedDeliveryDateDeleteTrackingByIdResponse struct {
...
type CustomEstimatedDeliveryDateDeleteTrackingByIdResponse struct {
...
type FirstEstimatedDeliveryDeleteTrackingByIdResponse struct {
    // Type The format of the EDD. Either a single date or a date range.
    Type string `json:"type,omitempty"`
...
type LatestEstimatedDeliveryDeleteTrackingByIdResponse struct {
    // Type The format of the EDD. Either a single date or a date range.
    Type string `json:"type,omitempty"`
    // Source The source of the EDD. Either the carrier, AfterShip AI, or based on your custom EDD settings.
    Source string `json:"source,omitempty"`
...
type CarbonEmissionsDeleteTrackingByIdResponse struct {
...
type FirstMileDeleteTrackingByIdResponse struct {
...
type LastMileDeleteTrackingByIdResponse struct {
...
type CustomersDeleteTrackingByIdResponse struct {
