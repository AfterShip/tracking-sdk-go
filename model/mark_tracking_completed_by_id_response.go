...
type MarkTrackingCompletedByIdResponse struct {
    ...
    AftershipEstimatedDeliveryDate *AftershipEstimatedDeliveryDateMarkTrackingCompletedByIdResponse `json:"aftership_estimated_delivery_date,omitempty"`
    ...
    CustomEstimatedDeliveryDate *CustomEstimatedDeliveryDateMarkTrackingCompletedByIdResponse `json:"custom_estimated_delivery_date,omitempty"`
    ...
    FirstEstimatedDelivery *FirstEstimatedDeliveryMarkTrackingCompletedByIdResponse `json:"first_estimated_delivery,omitempty"`
    ...
    LatestEstimatedDelivery *LatestEstimatedDeliveryMarkTrackingCompletedByIdResponse `json:"latest_estimated_delivery,omitempty"`
...
type CourierEstimatedDeliveryDateMarkTrackingCompletedByIdResponse struct {
...
type ShipmentWeightMarkTrackingCompletedByIdResponse struct {
...
type AftershipEstimatedDeliveryDateMarkTrackingCompletedByIdResponse struct {
...
type CustomEstimatedDeliveryDateMarkTrackingCompletedByIdResponse struct {
...
type FirstEstimatedDeliveryMarkTrackingCompletedByIdResponse struct {
    // Type The format of the EDD. Either a single date or a date range.
    Type string `json:"type,omitempty"`
...
type LatestEstimatedDeliveryMarkTrackingCompletedByIdResponse struct {
    // Type The format of the EDD. Either a single date or a date range.
    Type string `json:"type,omitempty"`
    // Source The source of the EDD. Either the carrier, AfterShip AI, or based on your custom EDD settings.
    Source string `json:"source,omitempty"`
...
type CarbonEmissionsMarkTrackingCompletedByIdResponse struct {
