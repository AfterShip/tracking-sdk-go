...
// Estimateddeliverydate2
type Estimateddeliverydate2 struct {
	...
	OriginAddress *OriginAddressEstimateddeliverydate2 `json:"origin_address"`
	// DestinationAddress The final destination of the customer where the delivery will be made.
	DestinationAddress *DestinationAddressEstimateddeliverydate2 `json:"destination_address"`
	// Weight AfterShip uses this object to calculate the total weight of the order.
	Weight *WeightEstimateddeliverydate2 `json:"weight,omitempty"`
	...
	EstimatedPickup *EstimatedPickupEstimateddeliverydate2 `json:"estimated_pickup,omitempty"`
...
// OriginAddressEstimateddeliverydate2
type OriginAddressEstimateddeliverydate2 struct {
...
// DestinationAddressEstimateddeliverydate2
type DestinationAddressEstimateddeliverydate2 struct {
...
// WeightEstimateddeliverydate2
type WeightEstimateddeliverydate2 struct {
...
// EstimatedPickupEstimateddeliverydate2
type EstimatedPickupEstimateddeliverydate2 struct {
	...
	// OrderProcessingTime
	OrderProcessingTime *OrderProcessingTimeEstimatedPickupEstimateddeliverydate2 `json:"order_processing_time,omitempty"`
	// PickupTime The local pickup time of the package.
	PickupTime string `json:"pickup_time,omitempty"`
}

// OrderProcessingTimeEstimatedPickupEstimateddeliverydate2
type OrderProcessingTimeEstimatedPickupEstimateddeliverydate2 struct {
