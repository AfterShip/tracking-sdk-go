...
// UpdateTrackingBySlugTrackingNumberResponse Object describes the tracking information.<div style="display:none; height: 0"></div>
type UpdateTrackingBySlugTrackingNumberResponse struct {
	...
	ShipmentWeight *ShipmentWeightUpdateTrackingBySlugTrackingNumberResponse `json:"shipment_weight,omitempty"`
	...
	AftershipEstimatedDeliveryDate *AftershipEstimatedDeliveryDateUpdateTrackingBySlugTrackingNumberResponse `json:"aftership_estimated_delivery_date,omitempty"`
	...
	CustomEstimatedDeliveryDate *CustomEstimatedDeliveryDateUpdateTrackingBySlugTrackingNumberResponse `json:"custom_estimated_delivery_date,omitempty"`
	...
	FirstEstimatedDelivery *FirstEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse `json:"first_estimated_delivery,omitempty"`
	...
	LatestEstimatedDelivery *LatestEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse `json:"latest_estimated_delivery,omitempty"`
	...
	NextCouriers []NextCouriersUpdateTrackingBySlugTrackingNumberResponse `json:"next_couriers,omitempty"`
	...
	CarbonEmissions *CarbonEmissionsUpdateTrackingBySlugTrackingNumberResponse `json:"carbon_emissions,omitempty"`
...
type ShipmentWeightUpdateTrackingBySlugTrackingNumberResponse struct {
...
type AftershipEstimatedDeliveryDateUpdateTrackingBySlugTrackingNumberResponse struct {
...
type CustomEstimatedDeliveryDateUpdateTrackingBySlugTrackingNumberResponse struct {
...
type FirstEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse struct {
	// Type The format of the EDD. Either a single date or a date range.
	Type string `json:"type,omitempty"`
...
type LatestEstimatedDeliveryUpdateTrackingBySlugTrackingNumberResponse struct {
	// Type The format of the EDD. Either a single date or a date range.
	Type string `json:"type,omitempty"`
	// Source The source of the EDD. Either the carrier, AfterShip AI, or based on your custom EDD settings.
	Source string `json:"source,omitempty"`
...
type NextCouriersUpdateTrackingBySlugTrackingNumberResponse struct {
...
type CarbonEmissionsUpdateTrackingBySlugTrackingNumberResponse struct {
