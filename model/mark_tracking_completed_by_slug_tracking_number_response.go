...
// MarkTrackingCompletedBySlugTrackingNumberResponse Object describes the tracking information.<div style="display:none; height: 0"></div>
type MarkTrackingCompletedBySlugTrackingNumberResponse struct {
	// Id Tracking ID.
	...
	ShipmentWeight *ShipmentWeightMarkTrackingCompletedBySlugTrackingNumberResponse `json:"shipment_weight,omitempty"`
	...
	AftershipEstimatedDeliveryDate *AftershipEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse `json:"aftership_estimated_delivery_date,omitempty"`
	...
	CustomEstimatedDeliveryDate *CustomEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse `json:"custom_estimated_delivery_date,omitempty"`
	...
	FirstEstimatedDelivery *FirstEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse `json:"first_estimated_delivery,omitempty"`
	...
	LatestEstimatedDelivery *LatestEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse `json:"latest_estimated_delivery,omitempty"`
	...
	NextCouriers []NextCouriersMarkTrackingCompletedBySlugTrackingNumberResponse `json:"next_couriers,omitempty"`
	...
	CarbonEmissions *CarbonEmissionsMarkTrackingCompletedBySlugTrackingNumberResponse `json:"carbon_emissions,omitempty"`
...
type ShipmentWeightMarkTrackingCompletedBySlugTrackingNumberResponse struct {
...
type AftershipEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse struct {
...
type CustomEstimatedDeliveryDateMarkTrackingCompletedBySlugTrackingNumberResponse struct {
...
type FirstEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse struct {
	// Type The format of the EDD. Either a single date or a date range.
	Type string `json:"type,omitempty"`
...
type LatestEstimatedDeliveryMarkTrackingCompletedBySlugTrackingNumberResponse struct {
	// Type The format of the EDD. Either a single date or a date range.
	Type string `json:"type,omitempty"`
	// Source The source of the EDD. Either the carrier, AfterShip AI, or based on your custom EDD settings.
	Source string `json:"source,omitempty"`
...
type NextCouriersMarkTrackingCompletedBySlugTrackingNumberResponse struct {
...
type CarbonEmissionsMarkTrackingCompletedBySlugTrackingNumberResponse struct {
