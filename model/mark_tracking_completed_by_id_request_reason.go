...
type MarkTrackingCompletedByIdRequestReason string

const (
	MarkTrackingCompletedByIdRequestReasonDelivered        MarkTrackingCompletedByIdRequestReason = "DELIVERED"
	MarkTrackingCompletedByIdRequestReasonLost             MarkTrackingCompletedByIdRequestReason = "LOST"
	MarkTrackingCompletedByIdRequestReasonReturnedToSender MarkTrackingCompletedByIdRequestReason = "RETURNED_TO_SENDER"
)
