...
type PredictResponse struct {
    ...
    OriginAddress *OriginAddressPredictResponse `json:"origin_address"`
    // DestinationAddress The final destination of the customer where the delivery will be made.
    DestinationAddress *DestinationAddressPredictResponse `json:"destination_address"`
    // Weight AfterShip uses this object to calculate the total weight of the order.
    Weight *WeightPredictResponse `json:"weight,omitempty"`
    ...
    EstimatedPickup *EstimatedPickupPredictResponse `json:"estimated_pickup,omitempty"`
...
type OriginAddressPredictResponse struct {
...
type DestinationAddressPredictResponse struct {
...
type WeightPredictResponse struct {
...
type EstimatedPickupPredictResponse struct {
    ...
    // OrderProcessingTime 
    OrderProcessingTime *OrderProcessingTimeEstimatedPickupPredictResponse `json:"order_processing_time,omitempty"`
    // PickupTime The local pickup time of the package. 
    PickupTime string `json:"pickup_time,omitempty"`
}

// OrderProcessingTimeEstimatedPickupPredictResponse 
type OrderProcessingTimeEstimatedPickupPredictResponse struct {
