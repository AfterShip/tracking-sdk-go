...
type PredictRequest struct {
	...
	OriginAddress *OriginAddressPredictRequest `json:"origin_address"`
	// DestinationAddress The final destination of the customer where the delivery will be made.
	DestinationAddress *DestinationAddressPredictRequest `json:"destination_address"`
	// Weight AfterShip uses this object to calculate the total weight of the order.
	Weight *WeightPredictRequest `json:"weight,omitempty"`
	...
	EstimatedPickup *EstimatedPickupPredictRequest `json:"estimated_pickup,omitempty"`
}

// OriginAddressPredictRequest
type OriginAddressPredictRequest struct {
...
type DestinationAddressPredictRequest struct {
...
type WeightPredictRequest struct {
...
type EstimatedPickupPredictRequest struct {
	...
	// OrderProcessingTime
	OrderProcessingTime *OrderProcessingTimeEstimatedPickupPredictRequest `json:"order_processing_time,omitempty"`
}

// OrderProcessingTimeEstimatedPickupPredictRequest
type OrderProcessingTimeEstimatedPickupPredictRequest struct {
